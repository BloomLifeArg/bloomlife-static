...
(function () {
  ...
  var NIVEL1 = [
    { texto: 'Adaptógenos', panel: 'adaptogenos' },
  ...
  function cargarCSS() {
    ...
    var h = resolver('../css/menu-nav-seed.css'); if (!h) return;
  ...
  function contenidoDrawer(d) {
    ...
    NIVEL1.filter(function (i) { return !i.panel; })
      .forEach(function (i) { var li = el('li'); var a = el('a', null, i.texto); a.href = i.href; li.appendChild(a); dir.appendChild(li); });
    d.appendChild(dir);
  }
